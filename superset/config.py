...
SQLALCHEMY_DATABASE_URI = config.mysql_connection_uri
...
WTF_CSRF_EXEMPT_LIST = ["superset.views.core.log", "superset.views.core.explore_json", "superset.charts.api.data", "superset.datasets.api.post", "superset.datasets.api.put", "superset.charts.api.post", "superset.dashboards.api.post", "superset.databases.api.post"]
...
OAUTH_PROVIDERS = [
    {   
        ...
        'remote_app': {
            ...
            'base_url':'https://data.ds2g.io',
            'access_token_url':'https://data.ds2g.io/api/oauth2/token',
            'authorize_url':'https://data.ds2g.io/api/oauth2/authorize',
            'logout_redirect_uri': 'https://data.ds2g.io/api/logout'
        },
    }
]
